...
```PowerShell
java -cp target/kafka-gourineni-1.0-SNAPSHOT-jar-with-dependencies.jar edu.nwmissouri.gourineni.kafka.CustomConsumer
```
...
```PowerShell
java -cp target/kafka-gourineni-1.0-SNAPSHOT-jar-with-dependencies.jar edu.nwmissouri.gourineni.kafka.CustomProducer
```
